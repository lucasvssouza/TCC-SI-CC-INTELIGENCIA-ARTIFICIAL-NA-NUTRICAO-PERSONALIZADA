    ...
    const { data, isFetching, error } = useQuery({
        ...
        queryFn: async () => {
            ...
            const response = await api.post<ResponseData>("/create", {
                ...
                level: user.level,
                hipertensive: user.hipertensive,
                diabetic: user.diabetic,
                allergies: user.allergies
            })

            if (!response.data || !response.data.data) {
                throw new Error("Dados da dieta inválidos")
            }
                ...
                {data && Object.keys(data).length > 0 && (
                    <>
                        ...
                        <Text style={styles.allergies}>
                            Alergia(s): {user.allergies || "Não possui"}
                        </Text>
                        ...
                        <ScrollView>
                            ...
                            <Pressable style={styles.button} onPress={() => router.replace("/step")}>
